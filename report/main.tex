...
\begin{figure}[!h]
    \centering
    \includegraphics[width=\textwidth]{pictures/techstack.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=\textwidth]{pictures/process.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{pictures/grafana.png}
    \caption{Grafana}
    \label{fig:grafana}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{pictures/sql_injections.png}
    \caption{Caption}
